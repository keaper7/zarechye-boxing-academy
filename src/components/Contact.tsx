      ...
      <div className="mt-12 grid gap-[var(--gutter)] lg:grid-cols-[minmax(0,1fr)_minmax(0,0.8fr)]">
        ...
        <ul className="divide-y divide-[var(--hair)] border-y border-[var(--hair)]">
          ...
          {/* Адрес — от заказчика, см. contact.place в content.ts. Номер
              ...
              а сервис без API-ключа ничего не гарантирует — не тот случай,
              чтобы вешать внешнюю зависимость ради одной картинки. Ссылка
              ниже ведёт на настоящие Яндекс Карты и открывает точную
